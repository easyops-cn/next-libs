...
describe("InstanceFormat", () => {
  it("should work", () => {
    ...
    expect(wrapper.find(".attr-field").at(0).text()).toBe("");
  ...
  it("attrData is string or number", () => {
    ...
    data.forEach((item) => {
      ...
      expect(wrapper.find(".attr-field").at(0).text()).toBe(item.value + "");
    });
  });
  it("attrData is null", () => {
  ...
  it("attrData is array", () => {
    ...
    expect(wrapper.find(".attr-field").at(0).text()).toBe('{a:"a"}; b');
  });
  ...
  it("attrData is enum", () => {
    ...
    expect(wrapper.find(".attr-field").at(0).text()).toBe("enum string");
  });
});

import { brickNextEntryRules, BrickNextRules } from "./BrickNextRules";
...
class CustomHighlightRules extends ace.acequire("ace/mode/yaml_highlight_rules")
  .YamlHighlightRules {
  constructor() {
    super();
...
export class BrickNextYamlMode extends ace.acequire("ace/mode/yaml").Mode {
  constructor() {
    super();

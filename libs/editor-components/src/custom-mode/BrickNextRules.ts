  ...
  placeholder: [
    {
      ...
      regex:
        "\\b(?:EVENT|DATA|PIPES|PARAMS|PATH|QUERY(?:_ARRAY)?|APP|HASH|ANCHOR|SYS|FLAGS|I18N|I18N_TEXT|CTX|SEGUE|ALIAS|PROCESSORS|IMAGES|TPL|PERMISSIONS|LOCAL_STORAGE|TAG_URL|SAFE_TAG_URL)\\b",
    },
    {

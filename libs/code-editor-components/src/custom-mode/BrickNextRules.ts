  ...
  placeholder: [
    {
      ...
      regex:
        "\\b(?:EVENT|DATA|PIPES|PARAMS|PATH|QUERY(?:_ARRAY)?|APP|HASH|ANCHOR|SYS|FLAGS|I18N|CTX|SEGUE|ALIAS|PROCESSORS|IMG|TPL|PERMISSIONS|LOCAL_STORAGE|TAG_URL|SAFE_TAG_URL|FN)\\b",
    },
    {
